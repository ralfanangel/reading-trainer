...
Handy: `http://192.168.1.20:8755/?v=29`

Wetter von Camarillo liegt unten über den Fotos: links °F, rechts dieselbe Temperatur in °C, Max/Min etwas größer. Oben rechts zeigt **Play** oder **Pause**. Oben zählt ein Timer von 28 auf 0; bei 0 kommt immer das nächste Foto, auch nach Tippen links/rechts. Nachricht zur Seite wischen: weg. Fotos füllen das Display. Querformat steht zuerst in der Mitte, die Bewegung geht nur hoch oder runter. Newsletter ist raus.
