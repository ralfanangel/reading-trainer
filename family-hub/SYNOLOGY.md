...
Handy: `http://192.168.1.20:8755/?v=24`

Wetter von Camarillo liegt unten über den Fotos. Oben rechts zeigt **Läuft** oder **Pause**. Nachricht zur Seite wischen: weg. Fotos füllen das Display (`object-fit: cover`). Leichte Bewegung über den Bildausschnitt, nicht über CSS-Transform (das hat den Zoom zerschossen). Links am Bildrand tippen: vorheriges Foto. Rechts tippen: nächstes Foto. Newsletter ist raus.
